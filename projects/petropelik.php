...
<?php
echo info(
	"Le site dispose aussi d'une interface d'administration qui permet d'organiser les catégories en arbre (c'est-à-dire qu'elles contiennent d'autres catégories) et de publier des projets."
);
?>
